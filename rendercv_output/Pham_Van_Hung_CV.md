...
- Website: [www.facebook.comphamhung.dev](https://www.facebook.com/phamhung.dev)
...
# Education
## **Ho Chi Minh City University of Technology**, Information Technology
...
# Experience
## **AS Solutions**, Backend Developer (Golang/Python)
...
**Databases & Storage:** PostgreSQL, MySQL, MSSQL, MongoDB, Neo4j, Milvus, Redis, MinIO

**Distributed Systems & Messaging:** Kafka, RabbitMQ, NSQ, gRPC, Protobuf, REST APIs, WebSocket

**Containerization & Virtualization:** Docker, Kubernetes, CI/CD, Rancher, VMware, VirtualBox, QEMU, Proxmox

**Monitoring & Observability:** Prometheus, Grafana, ELK Stack, Jaeger, OpenTelemetry

**System Architecture:** Microservices, Monolith, Clean Architecture, MVC
...
# Projects
## **[Search Engine](https://github.com/vincgo3/search-engine)**

Nov 2023 – present

Search for anything on your computer inspired by Everything
...
## **[Web Scraper](https://github.com/vincgo3/web-scraper)**

Nov 2023 – present

ANY.RUN Intelligence Scraper
...
## **[Yolo Shop](https://github.com/vincgo3/YoloShop-eCommerce-Project)**
